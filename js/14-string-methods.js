...
console.clear();
let input = '40782775362889846882292331077020083603063440024024364509628010238088491434787784429000231817057012805347934192669088583902848281252956348537109838951320423580';

function dalys(input, dalis) {
    let ats = [];
    for (let i = 0; i < stringas.length; i++)
        ats.push(stringas.slice(i, i++));
}
console.log(ats);
